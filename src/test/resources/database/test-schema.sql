-- Test schema for MySQL/MariaDB integration tests (reset before each *IT method).
-- Matches database/SentenceBuilderDatabase.sql without CREATE DATABASE / USE.
...
CREATE TABLE imports (
    ...
    UNIQUE KEY uq_imports_file_hash (file_hash)
);
