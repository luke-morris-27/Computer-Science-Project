...
@DisplayName("Generator Weighted Integration Tests")
public class WeightedGeneratorIT extends DatabaseIntegrationTestSupport {
    @Test
    @DisplayName("Weighted generation stores generated sentences and handles missing start words safely")
    ...
    @Test
    @DisplayName("Weighted generation returns an empty string when the database has no valid start words")
